...
class User implements IUser{
    ...
    password: number;
    email: any;
    constructor ( uId: number, uLogin: string, uPass :number, uEmail:any){
         this.id = uId
         this.login = uLogin;
         this.password = uPass;
         this.email = uEmail
...
function editUserOrDeleteUser(e): void {
...
function editElement(){
    ...
    arrUsers.forEach((user) =>{ user.id === editableUserId?
